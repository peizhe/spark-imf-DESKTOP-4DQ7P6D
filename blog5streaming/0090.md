...
##SparkStreaming On Kafka流程图
![SparkStreamingOnKafka](../image/90.SparkStreamingOnKafka.png)

##代码实战

SparkStreamingOnKafkaReceiver.java
...
public class SparkStreamingOnKafkaReceiver {
    public static void main(String[] args) {
         ...
         */
        SparkConf conf = new SparkConf().setAppName("WordCountOnlineJ").setMaster("local[4]");
        /**
         ...
         *  第二个参数是Zookeeper集群信息（接收Kafka数据的时候会从Zookeeper中获取Offset等元数据信息）；
        ...
        JavaPairReceiverInputDStream<String,String> lines = KafkaUtils.createStream(jsc, "MasterWin:2181" ,"MyFirstConsumerGroup",topicConsumerConcurrency);
        /**
         ...
         *  将每一行的字符串拆分成单个的单词
         */
        JavaDStream<String> words = lines.flatMap(tuple -> Arrays.asList(tuple._2().split(" ")) );
        /**
